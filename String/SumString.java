...
//    A string S is called a sum-string when it is broken down into more than one substring and
//    the rightmost substring can be written as a sum of two substrings before it and the same is recursively true
//    for substrings before it.
    ...
    private static boolean solve(String s, int pos, int l1, int l2) {
